...
create table coffeecart (coffee_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, coffee_name TEXT, coffee_description TEXT, category TEXT, price FLOAT, quantity INT);
